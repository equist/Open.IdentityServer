...
Open IdentityServer incorporates all the protocol implementations and extensibility points needed to integrate token-based authentication, single-sign-on and API access control in your applications. It is licensed under [Apache 2](https://opensource.org/licenses/Apache-2.0) (an OSI approved license).
...
* [Install](https://dotnet.microsoft.com/en-us/download) the latest .NET SDK
* Install Git
* Clone this repo
...
Please use the [issue tracker](https://github.com/RockSolidKnowledge/Open.IdentityServer/issues) and review the [Roadmap](./ROADMAP.md).
...
..and last but not least a big thanks to all our [contributors](https://github.com/RockSolidKnowledge/Open.IdentityServer/graphs/contributors)!
