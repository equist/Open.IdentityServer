...
This UI can be found in the `Quickstart UI repo <https://github.com/RockSolidKnowledge/Open.IdentityServer.Quickstart.UI/tree/main>`_.
...
You can inspect the source code `here <https://github.com/RockSolidKnowledge/Open.IdentityServer/blob/main/src/IdentityServer4/src/Test/TestUserProfileService.cs>`_
to see how it works.
