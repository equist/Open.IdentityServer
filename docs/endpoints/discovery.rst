...
The discovery endpoint is available via `/.well-known/openid-configuration` relative to the base address, for example if you base address is 'https://demo.identityserver.com'::
