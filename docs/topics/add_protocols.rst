...
Open.IdentityServer allows adding support for other protocols besides the built-in 
...
A sample for adding WS-Federation support can be found `here <https://github.com/RockSolidKnowledge/Samples.IdentityServer4.WsFederationIntegration>`_.
