...
public static class AuthenticationManagerExtensions
{
    ...
    /// <returns>A task that completes when the user has been signed in using the configured cookie authentication scheme.</returns>
    ...
    /// <returns>A task that completes when the user has been signed in using the configured cookie authentication scheme with the specified authentication properties.</returns>
