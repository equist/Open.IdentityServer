...
public static class HttpClientTokenRevocationExtensions
{
    ...
    /// <returns>A task that resolves to a <see cref="TokenRevocationResponse"/> indicating whether the revocation succeeded, or carrying error details if the request failed.</returns>
