...
public class BasicAuthenticationOAuthHeaderValue : AuthenticationHeaderValue
{
    ...
    /// <param name="userName">Name of the user.</param>
    /// <param name="password">The password.</param>
    /// <returns>A Base64-encoded string of the percent-encoded <paramref name="userName"/> and <paramref name="password"/> separated by a colon, suitable for use as the parameter of a Basic authentication header.</returns>
